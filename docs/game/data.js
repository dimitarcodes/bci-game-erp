...
misc.psd.desc = ["You plot the raw data and the raw data's frequency spectrum (PSD). The raw data points look awful but the PSD should give you some hints on what to do later on ;)", "You plot the data's frequency spectrum (PSD)", "You plot the data's frequency spectrum (PSD)", "You plot the data's frequency spectrum (PSD)", "You plot the data's frequency spectrum (PSD)", "You plot the data's frequency spectrum (PSD)", "You plot the data's frequency spectrum (PSD)", "You plot the data's frequency spectrum (PSD)", "You plot the data's frequency spectrum (PSD)"]
misc.psd.images = [['rawdataplot.png', 'rawdatapsd.png'], ['rawepochavgnts.png', 'rawepochavgtgs.png', 'rawdatapsd.png'], ['720hzepochntg.png', '720hzepochtgs.png', '720psd.png'],['720rawdataplot.png','720psd.png'],['16hzepochnts.png', '16hzepochtgs.png', '0516psd.png'],['16rawdataplot.png','0516psd.png']]
